...
class FirebaseWorkCloudStorage {
     final notes = FirebaseFirestore.instance.collection('workdaily');
 ...
 static final FirebaseWorkCloudStorage _shared= FirebaseWorkCloudStorage._sharedInstance();
  FirebaseWorkCloudStorage._sharedInstance();
  factory FirebaseWorkCloudStorage ()=>_shared;
}
