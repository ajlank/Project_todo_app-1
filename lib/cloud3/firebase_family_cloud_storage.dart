...
class FirebaseFamilyCloudStorage {
     final notes = FirebaseFirestore.instance.collection('familytask');
 ...
 static final FirebaseFamilyCloudStorage _shared= FirebaseFamilyCloudStorage._sharedInstance();
  FirebaseFamilyCloudStorage._sharedInstance();
  factory FirebaseFamilyCloudStorage ()=>_shared;
}
